...
# Traffic (PeMS road occupancy, 862 sensors) — large; only with --traffic.
TRAFFIC = {
    "traffic.csv": (None, 862),
}
...
def main() -> int:
    ...
    ap.add_argument("--traffic", action="store_true",
                    help="also fetch traffic.csv (862 channels, ~130 MB)")
    args = ap.parse_args()
